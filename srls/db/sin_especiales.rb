...
vicariaCentro = Church.create([{nombre: 'Divina Providencia - Hospicio', vicaria: 'Vicaria Centro'},
 ...
 {nombre: 'San Jose - S. Juan de Dios', vicaria: 'Vicaria Centro'}, {nombre: 'San Pedro', vicaria: 'Vicaria Centro'}, 
...
vicariaNorEste = Church.create([{nombre: 'V. del Carmen y S. M. Kolbe', vicaria: 'Vicaria Nor Este'}, 
	{nombre: 'N. Sr. de la Exaltacion - Recoleta', vicaria: 'Vicaria Nor Este'}, {nombre: 'Santa Ana - Cala Cala', vicaria: 'Vicaria Nor Este'},
...
vicariaNorCentro = Church.create([{nombre: 'Madre del Verbo Divino', vicaria: 'Vicaria Nor Centro'},
	{nombre: 'Ntra. Sra. de Guadalupe', vicaria: 'Vicaria Nor Centro'}, {nombre: 'Ntra. Sra. de la Anunciacion', vicaria: 'Vicaria Nor Centro'},
	{nombre: 'Santa Monica', vicaria: 'Vicaria Nor Centro'}])
...
vicariaNorOeste = Church.create([{nombre: 'Cristo Rey', vicaria: 'Vicaria Nor Oeste'}, {nombre: 'Ntra. Sra. de la Merced', vicaria: 'Vicaria Nor Oeste'},
	...
	{nombre: 'Inm. Corazon de Maria', vicaria: 'Vicaria Nor Oeste'}])

vicariaSurEste = Church.create([{nombre: 'Virgen de Fatima', vicaria: 'Vicaria Sur Este'}, {nombre: 'Ntra. Sra. de la Salette', vicaria: 'Vicaria Sur Este'},
	{nombre: 'San Eugenio de Macenod', vicaria: 'Vicaria Sur Este'}, {nombre: 'Santa Vera Cruz', vicaria: 'Vicaria Sur Este'},
	{nombre: 'Santa Maria del camino', vicaria: 'Vicaria Sur Este'}])
...
vicariaSurCentro = Church.create([{nombre: 'San Antonio de Padua', vicaria: 'Vicaria Sur Centro'}, {nombre: 'San Carlos Borromeo', vicaria: 'Vicaria Sur Centro'},
	{nombre: 'San Joaquin', vicaria: 'Vicaria Sur Centro'}, {nombre: 'San Juan Bautista - Alalay', vicaria: 'Vicaria Sur Centro'},
...
{nombre: 'Cuasi P. Don Bosco', vicaria: 'Vicaria Sur Oeste'}, {nombre: 'Cuasi P. Virgen del Socavon', vicaria: 'Vicaria Sur Oeste'}])

vicariaCapinota = Church.create([{nombre: 'San Agustin - Tapacari', vicaria: 'Vicaria Capinota'}, {nombre: 'A. Antonio de Padua - Arque', vicaria: 'Vicaria Capinota'},
{nombre: 'S. Juan Bautista - Tacopaya', vicaria: 'Vicaria Capinota'}, {nombre: 'S. Pablo Apostol - Capinota', vicaria: 'Vicaria Capinota'},
{nombre: 'S. Juan Bautista - Itapaya', vicaria: 'Vicaria Capinota'}, {nombre: 'Jesus de Challa - Aramasi', vicaria: 'Vicaria Capinota'},
{nombre: 'Cristo de Ramadas', vicaria: 'Vicaria Capinota'}, {nombre: 'San Bartolome - Bolivar', vicaria: 'Vicaria Capinota'}])

vicariaValleAlto = Church.create([{nombre: 'Apostol Santiago - Ansaldo', vicaria: 'Vicaria Valle Alto'},
	{nombre: 'Ntra. Sra. M. y S.A.P. - Tolata', vicaria: 'Vicaria Valle Alto'}, {nombre: 'N. S. de las Nieves - Santivanez', vicaria: 'Vicaria Valle Alto'},
	{nombre: 'Ntra. Sra. del Carmen - Cliza', vicaria: 'Vicaria Valle Alto'}, {nombre: 'S. Antonio de Padua - Tiraque', vicaria: 'Vicaria Valle Alto'},
	{nombre: 'San Bartolome - Arani', vicaria: 'Vicaria Valle Alto'}, {nombre: 'San Benito - V. Mendoza', vicaria: 'Vicaria Valle Alto'},
	{nombre: 'San Juan Bautista - Punata', vicaria: 'Vicaria Valle Alto'}, {nombre: 'San Pedro - Tarata', vicaria: 'Vicaria Valle Alto'},
	{nombre: 'Santa Barbara - Vacas', vicaria: 'Vicaria Valle Alto'}, {nombre: 'San Miguel - Toco', vicaria: 'Vicaria Valle Alto'}, 
...
vicariaValleBajo = Church.create([{nombre: 'Ntra. Sra. del Rosario - Vinto', vicaria: 'Vicaria Valle Bajo'},
	...
	{nombre: 'Santisima Trinidad - Quillacollo', vicaria: 'Vicaria Valle Bajo'}, {nombre: 'San Pedro - Sipe Sipe', vicaria: 'Vicaria Valle Bajo'},
...
vicariaAyopaya = Church.create([{nombre: 'Ntra. Sra. del Rosario - Cocapata', vicaria: 'Vicaria Ayopaya'},
	{nombre: 'S. Francisco de Asis - Independencia', vicaria: 'Vicaria Ayopaya'}, {nombre: 'San Jose Obrero - Kami', vicaria: 'Vicaria Ayopaya'},
	{nombre: 'S. Bartolome - Morochata', vicaria: 'Vicaria Ayopaya'}])
...
vicariaChapare = Church.create([{nombre: 'Exaltacion - Chipiriri', vicaria: 'Vicaria Chapare'}, {nombre: 'S. A. de Padua - V. Tunari', vicaria: 'Vicaria Chapare'},
	{nombre: 'V. del Rosario - Eterazama', vicaria: 'Vicaria Chapare'}, {nombre: 'Santisima Trinidad - Isiboro', vicaria: 'Vicaria Chapare'},])